...
{
    public const int HALF_UP   = PHP_ROUND_HALF_UP;
    public const int HALF_DOWN = PHP_ROUND_HALF_DOWN;
    public const int HALF_EVEN = PHP_ROUND_HALF_EVEN;
    public const int HALF_ODD  = PHP_ROUND_HALF_ODD;
}
